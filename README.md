...
focus:          Mobile & Backend Development
current_build:  Ledger — offline-first finance app
stack:          React Native (Expo) · Drizzle ORM · SQLite
fun_fact:       "sudo make me a sandwich" never works, still tries daily
```

</td>
<td width="45%" align="center">

<img src="https://github-readme-utils.vercel.app/api/gif/anime" width="230" alt="anime coding gif"/>
...
![React Native](https://img.shields.io/badge/-React%20Native-white?style=for-the-badge&logo=react&logoColor=61DAFB)
![Expo](https://img.shields.io/badge/-Expo-white?style=for-the-badge&logo=expo&logoColor=000020)
...
![Java](https://img.shields.io/badge/-Java-white?style=for-the-badge&logo=openjdk&logoColor=E76F00)
...
![CSS](https://img.shields.io/badge/-CSS-white?style=for-the-badge&logo=data:image/svg%2Bxml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHZpZXdCb3g9IjAgMCAyNCAyNCI%%3D%3D)
...
```bash
$ echo "Currently building: Ledger"
> An offline-first personal finance tracker.
> Stack: React Native (Expo) + Drizzle ORM + SQLite
> Goal: ship it, polish it, maybe sell it 💸
```
